			...
			<Dashboard title="Congratulations!">
				<div className="account-success account-base">
					...
					<p>
						...
						and design your own fonts. We are eager to see what you
						will be able to do with Prototypo. Please share your
						creations with us on{' '}
						<a
						...
						>
							Facebook
						</a>. If you have any questions or feedback, feel free
						to reach out to us at{' '}
						<a
							className="account-link"
							href="mailto:contact@prototypo.io"
						>
							contact@prototypo.io
						</a>.
					</p>
					<p>
						One more thing: If you are (or represent) a company and
						you need an invoice for your purchase, please go to{' '}
						<Link
							className="account-link"
