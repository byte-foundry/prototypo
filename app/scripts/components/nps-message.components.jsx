		...
		return (
			<div className="nps-message">
				<div className="nps-message-content">
					<h1 className="nps-message-content-title">You've been subscribed to Prototypo for some time, and we'd like to get your feedback !</h1>
					<p className="nps-message-content-question">How likely are you to recommend Prototypo to a friend or colleague ?</p>
					...
					<p className="nps-message-content-question">What is the most important reason for your score ?</p>
					<textarea className="nps-message-content-text"></textarea>
