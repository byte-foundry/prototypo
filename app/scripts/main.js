...
selectRenderOptions(
	...
	() => {
		...
		HoodieApi.setup()
			.then(() => {
				if (location.hash.indexOf('signin') === -1 && location.hash.indexOf('account') === -1 && location.hash.indexOf('academy') === -1 && location.hash.indexOf('signup') === -1 &&  location.hash.indexOf('dashboard') === -1) {
