...
storiesOf('onboarding/OnboardingStep', module)
	.add('start', () => <OnboardingStep title="Title" type="start" description={['description']} />)
	.add('sliders', () => (<OnboardingStep
		type="sliders"
	...
	.add('serifs', () => (<OnboardingStep
		...
		fontName="sans-serif"
	/>))
	.add('finish', () => <OnboardingStep type="finish" fontName="sans-serif" description={['description']} />);
