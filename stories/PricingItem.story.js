...
storiesOf('shared.PricingItem', module)
	...
	.add('with title', () => <PricingItem currency="EUR" amount={5} title="Monthly" />)
	.add('with price info', () => (
		<PricingItem currency="EUR" amount={5} priceInfo="Billed annually" />
	))
	.add('with children', () => (
		<PricingItem currency="EUR" amount={5} priceInfo="Billed annually">
			<p style={{padding: '10px', textAlign: 'center', margin: '0'}}>You can put anything you want to extend this element</p>
		</PricingItem>
	))
