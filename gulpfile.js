...
gulp.task('cp-genese', function() {
	...
	gulp.src('./node_modules/serif.ptf/dist/font.json')
		.pipe(gulp.dest('./dist/serif.ptf/dist/'));
});
...
gulp.task('watch-font', function() {
	return gulp.watch(['./node_modules/john-fell.ptf/dist/font.json','./node_modules/venus.ptf/dist/font.json','./node_modules/elzevir.ptf/dist/font.json','./node_modules/serif.ptf/dist/font.json'], ['cp-genese']);
});
